import {
    DOCUMENT_LOADED, REMOVE_LOADING, SET_LOADING
} from "../actions/types";
import axios from "axios";
import { api_provider } from "../utils/apiProvider";
import { CREATE_DOCUMENT, GET_DOCUMENTS,DELETE_DOCUMENT } from "../utils/end_points";
...
//get documents
export const get_documents = (body,description) => {
    return async (dispatch) => {
        dispatch({ type: SET_LOADING })
        try {
            const res = await axios.get(api_provider(GET_DOCUMENTS), { params: { body,description } });
            ...
            if (res && res.data && res.data.result) {
                ...
                dispatch({
                    ...
                    payload: { documents: res.data.result, filters: filters },
                });

            } else {
                dispatch({
                    type: DOCUMENT_LOADED,
                    payload: { documents: [], filters: {} },
                });
            }
